 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Inky\CourseBundle\Entity\ImageRepository")
...
class Image
{
	...
	*/
	public function upload()
	{
		...
		// On déplace le fichier envoyÃ© dans le rÃ©pertoire de notre choix
		$this->file->move(
