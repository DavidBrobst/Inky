 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Inky\CourseBundle\Entity\CourseRepository")
 */
class Course
{
    /**
	...
	/**
	 * @ORM\OneToOne(targetEntity="Inky\CourseBundle\Entity\Image", cascade={"persist", "remove"})
	 */
	private $image;
	...
	/**
	 * @ORM\OneToMany(targetEntity="Inky\CourseBundle\Entity\Lesson", cascade={"persist", "remove"}, mappedBy="course")
	 */
	private $lesson;
	...
	*/
	...
	/**
	* @ORM\ManyToMany(targetEntity="Inky\CourseBundle\Entity\Tag",cascade={"persist"}, mappedBy="course")
	...
	*/
     ...
     * Set image
     *
     * @param \Inky\CourseBundle\Entity\Image $image
     * @return Course
     */
    public function setImage(\Inky\CourseBundle\Entity\Image $image = null)
    {
        $this->image = $image;
     ...
     * Get image
     *
     * @return \Inky\CourseBundle\Entity\Image 
     */
     ...
     * @return Course
     */
    public function addTag(\Inky\CourseBundle\Entity\Tag $tags)
    {
        $this->tags[] = $tags;
     ...
     * @return Course
     */
    public function addLesson(\Inky\CourseBundle\Entity\Lesson $lesson)
    {
        $this->lesson[] = $lesson;
     ...
     * @param \Inky\CourseBundle\Entity\Lesson $lesson
     */
    public function removeLesson(\Inky\CourseBundle\Entity\Lesson $lesson)
    {
